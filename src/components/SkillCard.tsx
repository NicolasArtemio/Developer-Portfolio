...
const SkillCard = ({ skill }: SkillCardProps) => (
  <motion.div
    ...
    className="group p-8 bg-[var(--surface-1)] backdrop-blur-xl rounded-[2.5rem] ring-1 ring-[var(--border-color)] shadow-sm transition-all duration-300 hover:shadow-xl hover:shadow-[var(--accent-primary)]/10 hover:-translate-y-1 text-[var(--text-primary)]"
  >
    {/* Ícono */}
    <div
